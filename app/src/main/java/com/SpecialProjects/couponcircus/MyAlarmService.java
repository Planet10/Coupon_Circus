package com.SpecialProjects.couponcircus;
...
import static com.SpecialProjects.couponcircus.R.drawable.ic_action_dismiss;
import static com.SpecialProjects.couponcircus.R.string.*;
       ...
       // dismissIntent.setAction();
        ...
        .setSmallIcon(R.drawable.ic_launcher)
                ...
                .setStyle(new NotificationCompat.BigTextStyle()
                        ...
                        .bigText(msg))
                .addAction(ic_action_dismiss, getString(action_dismiss), piDismiss)
